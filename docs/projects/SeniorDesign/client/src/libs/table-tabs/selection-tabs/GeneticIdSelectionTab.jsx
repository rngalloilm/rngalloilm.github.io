...
function GeneticIdTab(props) {
  ...
  return (
      <div>
        {data ? <TableComponent editLink="/material/genetic-id/edit" addLink="/material/genetic-id/add"  status={"active"} material={"geneticId"} rows={rows} columns={columns} loading={loading} error={error} user={props.user} isOfflineSelection={true} /> : <p></p>}
      </div>
  )
}
